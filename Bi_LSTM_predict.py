...
try:
    # 数据预处理
    input_shape = 60
    sent = 'The United States is a founding member of the United Nations, World Bank, International Monetary Fund. international diplomacy.'
    sent2 = 'Oxford is in England, Jack is from here.'
